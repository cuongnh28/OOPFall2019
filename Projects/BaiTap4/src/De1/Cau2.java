    ...
    class chaychu extends Thread{
        public void run() {
            while(true){
                ...
                //chay sang trai.
//                jLabel2.setText(str.substring(1,str.length())+str.charAt(0));
                //chay sang phai
                jLabel2.setText(str.charAt(str.length()-1)+str.substring(0, str.length()-1));
                try {
                    sleep(200);
                } catch (InterruptedException ex) {
                    System.out.println(ex);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tôi yêu học viện hoàng gia PTIT của tôi.");
